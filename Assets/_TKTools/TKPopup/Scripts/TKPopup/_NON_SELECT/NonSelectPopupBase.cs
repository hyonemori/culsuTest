...
namespace TKPopup
{
    public class NonSelectPopupBase : PopupBase
    {
        /// <summary>
...
#region Public Method
        ...
        public NonSelectPopupBase SetCancelButton(bool enable)
        {
        ...
        public NonSelectPopupBase SetTitle(string title)
        {
        ...
        /// <param name="enable">If set to <c>true</c> enable.</param>
        public NonSelectPopupBase SetConfirmButtonInteractable(bool isInteractable)
        {
        ...
        public NonSelectPopupBase SetDescription(string description)
        {
        ...
        public NonSelectPopupBase OnCancelButtonClickedOrOnTappedOutOfPopupRangeDelegate(System.Action handler)
        {
        ...
        /// <param name="enable">If set to <c>true</c> enable.</param>
        public NonSelectPopupBase IsCloseOnTappedOutOfPopupRange(bool enable)
        {
        ...
        public NonSelectPopupBase SetConfirmButtonText(string text)
        {
        ...
        /// </summary>
        /// <param name="handler">Handler.</param>
        public NonSelectPopupBase OnClosePopupDelegate(System.Action handler)
        {
        ...
        public NonSelectPopupBase ReplaceMainContent(RectTransform content)
        {
