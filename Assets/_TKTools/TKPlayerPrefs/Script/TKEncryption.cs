namespace TKF
{
    ...
    /// </summary>
    public static class TKEncryption
    {
        public static string PASS = "ynmfNqUYih5sFNQFu3ju";
        public static string SALT = "X3Hpevt1jw5EaJK5XCx9";

        static System.Security.Cryptography.RijndaelManaged rijndael;

        /// <summary>
        /// Initializes the <see cref="TKF.Enc"/> class.
        /// </summary>
        static TKEncryption()
        {
