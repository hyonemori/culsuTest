...
namespace TKF
{
	public static class FuncExtensions
	{
		...
		public static TResult SafeInvoke<T1, T2, T3, TResult> (this Func<T1, T2, T3, TResult> func,
		                                                       T1 arg1,
		                                                       T2 arg2,
		                                                       T3 arg3)
		{
		...
		public static TResult SafeInvoke<T1, T2, T3, T4, TResult> (this Func<T1, T2, T3, T4, TResult> func,
		                                                           T1 arg1,
		                                                           T2 arg2,
		                                                           T3 arg3,
		                                                           T4 arg4)
