    ...
    , IComparable<BigDecimal>
    {
        ...
        public void Normalize()
        {
            ...
            else
            {
                ...
                while (remainder == 0)
                {
                    var shortened = Mantissa.DivideAndRemainder(10, out remainder);
                    if (remainder == 0)
                    {
                        Mantissa = shortened;
                        Exponent++;
        ...
        private static int NumberOfDigits(BigInteger value)
        {
            ...
            // faster version
            return (int)Math.Ceiling((double)BigInteger.Log10(value * value.Sign));
        }
...
#region Conversions
        ...
        {
            return (int)(value.Mantissa * Multiplication.Pow(10, value.Exponent));
        }

        public static explicit operator uint(BigDecimal value)
        {
            return (uint)(value.Mantissa * Multiplication.Pow(10, value.Exponent));
        }
...
#region Operators
        ...
        public static BigDecimal operator /(BigDecimal dividend, BigDecimal divisor)
        {
            ...
            dividend.Mantissa *= Multiplication.Pow(10, exponentChange);
        ...
        {
            return value.Mantissa * Multiplication.Pow(10, value.Exponent - reference.Exponent);
        }
