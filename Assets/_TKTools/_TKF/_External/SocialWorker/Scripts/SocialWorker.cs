...
namespace SWorker
{
    ...
    public class SocialWorker : MonoBehaviour
    {
        ...
        private static extern void postMail
            (string to, string cc, string bcc, string subject, string message, string imagePath);
        ...
        public static void PostTwitter
            (string message, string url, string imagePath, Action<SocialWorkerResult> onResult = null)
        {
            if (message == null)
            {
                message = "";
        ...
        (
            ...
            string message,
            string imagePath,
            Action<SocialWorkerResult> onResult = null)
        {
            if (to == null)
            {
                to = new string[] {""};
        ...
        public void OnSocialWorkerResult(string res)
        {
            if (onResult != null)
            {
                onResult.SafeInvoke((SocialWorkerResult) int.Parse(res));
                onResult = null;
            }
        }
    }
